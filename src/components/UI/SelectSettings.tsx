...
export const SelectSettings: FC<SelectProps> = ({id, options, label, action}) => {
    ...
    return (
        <div className='select'>
            ...
            <select className='select__input' disabled = {categoriesLoading} id={id} value={selectValue} onChange={onChangeHandler}>
