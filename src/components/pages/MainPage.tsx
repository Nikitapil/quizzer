...
import {fetchCategories, setCategories, setDifficulty, setType } from '../../redux/actionCreators'
    ...
    return (
        <main className='mainpage__container container'>
            ...
            <form className='settings-form' onSubmit={submitHandler}>
                <SelectSettings id= 'questionCategory' label='Select Category' options = {categories} action={setCategories}/>
