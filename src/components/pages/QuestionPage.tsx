...
export const QuestionPage: FC = () => {
  ...
  const { questionsAmount, questionCategory, questionDificulty, questionType } =
    useTypedSelector((state) => state.main);
  const { questions, questionLoading, score, questionError } = useTypedSelector(
  ...
  return (
    <main className="question__container container">
      ...
      {!questionLoading && questions.length === 0 && (
        <p>
          Sorry! there is no question that mathes to your parametres, go back
